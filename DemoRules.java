...
public class DemoRules extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_rules);
        ...
        //rule2.setText("2) You can attempt the next question only after choosing an answer for the current question , there is no option of skipping a question");
        ...
        btn = (Button)findViewById(R.id.hbtn);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DemoRules.this, NavActivity.class));
            }
        });
    }
}
