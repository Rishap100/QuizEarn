...
public class DemoQuiz extends AppCompatActivity {
    ...
    public void onBackPressed(){
        Toast.makeText(DemoQuiz.this,"Sorry can't go back",Toast.LENGTH_LONG).show();
    }
    @Override
    ...
    private void updateQuestions()
    {
        ...
        if(total>20)
        {
            ...
            b4.setEnabled(false);
            //startActivity(i);
            Toast.makeText(DemoQuiz.this,"Please wait for the timer to end",Toast.LENGTH_LONG).show();
            //MainActivity.this.finish();
        }
        else
        {
            reference= FirebaseDatabase.getInstance().getReference().child("DemoQuestions").child(String.valueOf(q));
    ...
    public void reversetimer(int seconds,final TextView tv) {
        new CountDownTimer(seconds * 1000 + 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(DemoQuiz.this, DemoResult.class);
